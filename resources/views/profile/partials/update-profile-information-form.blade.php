<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="employed_company" name="employed_company" type="text" class="mt-1 block w-full" :value="old('employed_company', $user->employed_company)" />
            <x-input-error class="mt-2" :messages="$errors->get('employed_company')" />
        </div>
